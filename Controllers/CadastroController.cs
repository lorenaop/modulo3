...
namespace Home.Controllers
{
    public class CadastroController : Controller
    {
        ...
        public CadastroController(PassagemContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Cpf")] Cadastro cadastro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Cpf")] Cadastro cadastro)
        {
            if (id != cadastro.Id)
            {
                return NotFound();
