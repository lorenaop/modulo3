...
namespace Home.Controllers
{
    public class DestinoController : Controller
    {
        ...
        public DestinoController(PassagemContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Local")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Local")] Destino destino)
        {
            if (id != destino.Id)
            {
                return NotFound();
